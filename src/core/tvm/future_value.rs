...
pub(crate) fn future_value_solution_internal(rate: f64, periods: f64, present_value: f64, continuous_compounding: bool) -> TvmSolution {
    ...
    TvmSolution::new_fractional_periods(TvmVariable::FutureValue, CalculationType::Core, continuous_compounding, rate, periods, present_value, future_value, &formula, symbolic_formula)
}
