...
pub (crate) fn rate_solution_internal(periods: u32, present_value: f64, future_value: f64, continuous_compounding: bool) -> TvmSolution {
    if present_value == 0.0 && future_value == 0.0 {
        ...
        let rate = 0.0;
        return TvmSolution::new(TvmVariable::Rate, CalculationType::Core, continuous_compounding, rate, periods, present_value, future_value, formula, symbolic_formula);
    }
    ...
    TvmSolution::new(TvmVariable::Rate, CalculationType::Core, continuous_compounding, rate, periods, present_value, future_value, &formula, symbolic_formula)
}
