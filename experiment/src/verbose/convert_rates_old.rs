...
pub fn convert_apr_to_ear_solution(apr: f64, compounding_periods_in_year: u32) -> AprEarSolution {
...
pub fn convert_apr_to_ear(apr: f64, compounding_periods_in_year: u32) -> f64 {
    convert_apr_to_ear_solution(apr, compounding_periods_in_year).effective_annual_rate
}
...
pub fn convert_ear_to_apr_solution(ear: f64, compounding_periods_in_year: u32) -> AprEarSolution {
    let n = compounding_periods_in_year as f64;
...
pub fn convert_ear_to_apr(ear: f64, compounding_periods_in_year: u32) -> f64 {
    convert_ear_to_apr_solution(ear, compounding_periods_in_year).annual_percentage_rate
}
...
pub fn convert_apr_to_periodic_solution(apr: f64, num_periods_in_year: u32) -> AprPeriodicSolution {
...
pub fn convert_apr_to_periodic(apr: f64, num_periods_in_year: u32) -> f64 {
    convert_apr_to_periodic_solution(apr, num_periods_in_year).periodic_rate
}

/// Convert periodic rate to APR (aka Annual rate, nominal interest rate, Annual Percentage Rate). Returns a custom solution type.
pub fn convert_periodic_to_apr_solution(periodic_rate: f64, periods_per_year: u32) -> AprPeriodicSolution {
...
pub fn convert_periodic_to_apr(periodic_rate: f64, periods_per_year: u32) -> f64 {
    convert_periodic_to_apr_solution(periodic_rate, periods_per_year).annual_percentage_rate
}
...
pub fn convert_apr_to_ear_continuous_compound_solution(apr: f64) -> AprEarContinous {
    assert!(apr.is_finite());
    if apr > 1. || apr < -1. {
        warn!("You provided an APR of {}%. Are you sure?", apr*100.);
    }
...
pub fn convert_apr_to_ear_continuous_compound(apr: f64) -> f64 {
    convert_apr_to_ear_continuous_compound_solution(apr).ear
}
...
/// Convert an EAR (Effective Annual Rate) to periodic rate.
pub fn convert_ear_to_periodic(ear: f64, periods_per_year: u32) -> f64 {
...
mod tests {
    ...
    fn test_apr_to_periodic_f64_1() {
        ...
        let actual_output = convert_apr_to_periodic(input_rate, periods);
    ...
    */
    ...
    fn test_apr_to_periodic_1() {
        ...
        let periods = 6;
        let expected_output = 0.00500;
        let actual_output = convert_apr_to_periodic_solution(input_rate, periods).periodic_rate;
        assert!( float_cmp::approx_eq!(f64, expected_output, actual_output, ulps = 4) );
    }
    ...
    fn test_apr_to_periodic_13() {
        ...
        let input_rate = 1_f64 / 0_f64;
        let periods = 3;
        let _should_panic = convert_apr_to_periodic_solution(input_rate, periods);
    }
    ...
    */
    ...
    fn test_periodic_to_apr_f64_1() {
        ...
        let actual_output = convert_periodic_to_apr(input_rate, periods);
        assert!( float_cmp::approx_eq!(f64, expected_output, actual_output, ulps = 4) );
    }
    ...
    */
    ...
    fn test_periodic_to_apr_1() {
        ...
        let periods = 6;
        let expected_output = 0.03;
        let actual_output = convert_periodic_to_apr_solution(input_rate, periods).annual_percentage_rate;
        assert!( float_cmp::approx_eq!(f64, expected_output, actual_output, ulps = 4) );
    }
    ...
    fn test_periodic_to_apr_13() {
        ...
        let input_rate = 1_f64 / 0_f64;
        let periods = 3;
        let _should_panic = convert_periodic_to_apr_solution(input_rate, periods);
    }
    ...
    */
    ...
    fn test_apr_to_ear_f64_1() {
        ...
        let actual_output = convert_apr_to_ear(input_rate, periods);
        assert_eq!(round_to_ulps_6(expected_output), round_to_ulps_6(actual_output));
    }
    ...
    */
    ...
    fn test_apr_to_ear_1() {
        ...
        let periods = 12;
        let expected_output = 0.03298851181;
        let actual_output = convert_apr_to_ear_solution(input_rate, periods).effective_annual_rate;
        assert_eq!(round_to_ulps_6(expected_output), round_to_ulps_6(actual_output));
    }
    ...
    fn test_apr_to_ear_8() {
        ...
        let input_rate = 1_f64/0_f64;
        let periods = 12;
        let _should_panic = convert_apr_to_ear_solution(input_rate, periods);
    }
    ...
    */
    ...
    fn test_ear_to_apr_6() {
        ...
        let input_rate = -1.1;
        let periods = 12;
        let _should_panic = convert_ear_to_apr_solution(input_rate, periods).annual_percentage_rate;
    }
    ...
    fn test_ear_to_apr_7() {
        ...
        let input_rate = -1.0;
        let periods = 12;
        let actual_output = convert_ear_to_apr_solution(input_rate, periods);
    }
    ...
    fn test_ear_to_apr_8() {
        ...
        let input_rate = 1_f64/0_f64;
        let periods = 12;
        let _should_panic = convert_ear_to_apr_solution(input_rate, periods);
    }
    ...
    */
    ...
    fn test_apr_to_ear_continuous_compound_f64_8() {
        // rate = infinity
        let input_rate = 1_f64/0_f64;
        let _should_panic = convert_apr_to_ear_continuous_compound(input_rate);
    }
    ...
    */
    ...
    fn test_apr_to_ear_continuous_compound_8() {
        // rate = infinity
        let input_rate = 1_f64/0_f64;
        let _should_panic = convert_apr_to_ear_continuous_compound_solution(input_rate).ear;
    }
